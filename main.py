...
def make_QA_pair(doc:Document):
    ...
    for question in questions:
        ...
        sample = {
                "question":question, 
                "chosen":preference, 
                "reject":[answer for answer in answers if answer.student_name != preference.student_name]
            }
        print(sample["question"].content)
        print(sample["chosen"].content)
        print(sample["reject"][0].content)
        print("\n\n\n")
